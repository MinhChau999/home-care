    ...
    >
      <div class="simplebar-wrapper" style="margin: 0px">
              ...
              <div class="simplebar-content" style="padding: 0px">
                ...
                <ul class="metismenu side-nav mm-show">
                    ...
                    >
                      ...
                      <li>
                        <a href="apps-projects-gantt.html"
                          >Gantt
                          <span
                            class="badge badge-pill badge-light-lighten font-10 float-right"
                            >New</span
                          ></a
                        >
                      </li>
                      <li>
                        <a href="apps-projects-add.html"
                          >Create Project
                          <span
                            class="badge badge-pill badge-success-lighten font-10 float-right"
                            >New</span
                          ></a
                        >
                      </li>
                  ...
                  <li class="side-nav-item">
                    ...
                    >
                      ...
                      <li class="side-nav-item">
                        ...
                        <ul
                          class="side-nav-third-level mm-collapse"
                          aria-expanded="false"
                        >
                          <li>
                          ...
                          <li>
                            <a href="pages-confirm-mail-2.html"
                              >Confirm Mail 2</a
                            >
                          </li>
                        </ul>
                  ...
                  <li class="side-nav-item mm-active">
                    ...
                    <ul
                      class="side-nav-second-level mm-collapse mm-show"
                      aria-expanded="false"
                    >
                      <li class="mm-active">
                        <a href="layouts-vertical.html" class="active"
                          >Vertical</a
                        >
                      </li>
                      <li>
                      ...
                      <li class="side-nav-item">
                        ...
                        >
                          ...
                          <li class="side-nav-item">
                            ...
                            <ul
                              class="side-nav-forth-level mm-collapse"
                              aria-expanded="false"
                            >
                              <li>
        ...
        <div
          ...
          style="width: auto; height: 1543px"
        ></div>
      </div>
      <div
