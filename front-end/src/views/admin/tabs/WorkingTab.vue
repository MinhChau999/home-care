  ...
  <div class="working-tab">
    ...
    <div class="border rounded mt-2 mb-3">
      <form action="#" class="comment-area-box">
        ...
        >
          <div>
            <a href="#" class="btn btn-sm px-2 font-16 btn-light"
    ...
    <div class="border border-light rounded p-2 mb-3">
      ...
      <div class="mt-2">
        ...
        >
        <a href="javascript: void(0);" class="btn btn-sm btn-link text-muted"
          ><i class="mdi mdi-heart-outline"></i> Like</a
        >
        <a href="javascript: void(0);" class="btn btn-sm btn-link text-muted"
    ...
    <div class="border border-light rounded p-2 mb-3">
      ...
      <div class="font-16 text-center font-italic text-dark">
        ...
        Cras purus odio, vestibulum in vulputate at, tempus viverra turpis. Duis
      ...
      <div class="mt-2">
        <a href="javascript: void(0);" class="btn btn-sm btn-link text-danger"
          ><i class="mdi mdi-heart"></i> Like (28)</a
        >
        <a href="javascript: void(0);" class="btn btn-sm btn-link text-muted"
          ><i class="mdi mdi-share-variant"></i> Share</a
        >
