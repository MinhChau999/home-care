  ...
  <div class="landing-page">
    ...
    <nav class="navbar navbar-expand-lg py-lg-3 navbar-dark">
      <div class="container">
        ...
        <!-- menus -->
        <div
          class="collapse navbar-collapse navbar-font"
          ...
          <div class="col-md-5">
            <div class="mt-md-4">
              ...
              <a href="" target="_blank" class="btn btn-success"
                >Preview <i class="mdi mdi-arrow-right ml-1"></i
              ></a>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="card card-pricing card-pricing-recommended">
              <div class="card-body text-center">
                ...
                <i
                  class="card-pricing-icon dripicons-briefcase text-primary"
                ></i>
          ...
          <div class="col-lg-12">
            <div class="text-center">
              ...
              <button type="button" class="btn btn-success btn-sm mt-2">
                <i class="mdi mdi-email-outline mr-1"></i> Email us your
                question
              </button>
    ...
    >
      <div class="container">
        ...
        <div class="row align-items-center mt-3">
          <div class="col-md-4">
            <p class="text-muted">
              <span class="font-weight-bold">Customer Support:</span><br />
            ...
            <p class="text-muted mt-4">
              <span class="font-weight-bold">Office Time:</span><br />
              ...
              <div class="row mt-2">
                <div class="col-12 text-right">
                  <button class="btn btn-primary">
                    Send a Message <i class="mdi mdi-telegram ml-1"></i>
                  </button>
                </div>
              </div>
            </form>
        ...
        <div class="row">
          ...
          <div class="col-lg-2 mt-3 mt-lg-0">
            ...
            <ul class="list-unstyled pl-0 mb-0 mt-3">
              ...
              <li class="mt-2">
                <a href="javascript: void(0);" class="text-white-50">Email</a>
              </li>
              <li class="mt-2">
                <a href="javascript: void(0);" class="text-white-50"
                  >Social Feed</a
          ...
          <div class="col-lg-2 mt-3 mt-lg-0">
            ...
            <ul class="list-unstyled pl-0 mb-0 mt-3">
              ...
              <li class="mt-2">
                <a href="javascript: void(0);" class="text-white-50">Privacy</a>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div class="col-lg-12">
            <div class="mt-5">
              <p class="text-white-50 mt-4 text-center mb-0">
                © 2018 - 2020 Hyper. Design and coded by Coderthemes
              </p>
            </div>
          </div>
        </div>
