                          ...
                          ><span
                            ...
                            ><span class="selection"
                              ><span
                                ...
                                tabindex="0"
                                aria-disabled="false"
                                aria-labelledby="select2-obsc-container"
                                ><span
                                  class="select2-selection__rendered"
                                  id="select2-obsc-container"
                                  role="textbox"
                                  aria-readonly="true"
                ...
                <div class="col-lg-8">
                  ...
                  <form>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label for="new-adr-email-address"
                            >Email Address
                            <span class="text-danger">*</span></label
                          >
                          <input
                          ...
                          ><span
                            ...
                            ><span class="selection"
                              ><span
                                ...
                                tabindex="0"
                                aria-disabled="false"
                                aria-labelledby="select2-2kax-container"
                                ><span
                                  class="select2-selection__rendered"
                                  id="select2-2kax-container"
                                  role="textbox"
                                  aria-readonly="true"
                                  title="Select Country"
                                  >Select Country</span
